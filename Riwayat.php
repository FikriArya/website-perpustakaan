        ...
        <div class="container-fluid">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
              <div class="white-box">
                <div class="d-md-flex mb-3">
                  <h3 class="box-title mb-0">Buku yg dipinjam</h3>
                </div>
                  ...
                  <table class="table no-wrap">
                    <thead>
                      <tr>
                        ...
                        <th class="border-top-0">Jumlah yg dipinjam</th>
                    ...
                    $conn->query("UPDATE riwayat_pinjam SET id = (@row := @row + 1)");

                    $result = $conn->query("SELECT * FROM riwayat_pinjam ORDER BY id ASC");
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
              <div class="white-box">
                <div class="d-md-flex mb-3">
                  <h3 class="box-title mb-0">Buku yg dikembalikan</h3>
                </div>
                <div class="table-responsive">
                  <table class="table no-wrap">
                    <thead>
                      <tr>
                        ...
                        <th class="border-top-0">Nama Buku</th>
                        <th class="border-top-0">Tanggal Peminjaman</th>
                        <th class="border-top-0">Tanggal Pengembalian</th>
                        <!-- <th class="border-top-0">ID Buku</th> -->
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    $conn->query("SET @row = 0");
                    $conn->query("UPDATE riwayat_kembalikan SET id = (@row := @row + 1)");

                    $result = $conn->query("SELECT * FROM riwayat_kembalikan ORDER BY id ASC");
